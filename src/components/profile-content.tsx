...
import { User, Mail, Building2, MapPin, Camera, Shield, Bell, CreditCard, Save, Key } from "lucide-react"
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2 sm:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="address" defaultValue="Rua das Flores, 123, 4000-001 Porto" className="pl-9" />
                  </div>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">Proteja a sua conta com autenticação em duas etapas</p>
              </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Receber um resumo semanal da atividade da conta</p>
                </div>
            ...
            <CardContent>
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">Renova em 30 dias • 3.716 digitalizações restantes</p>
                </div>
              </div>
